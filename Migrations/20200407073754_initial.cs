        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfflineTimeStamp = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: true),
                    OnlineTimeStamp = table.Column<DateTime>(nullable: false),
                    DesktopClientId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientMacAddress = table.Column<string>(nullable: true),
                    ClientType = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DesktopClients", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UId2 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenditures_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenditures_CostCategories_CostCategoryId",
                        column: x => x.CostCategoryId,
                        principalTable: "CostCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Expenditures_Users_IssuerId",
                        column: x => x.IssuerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incomes_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenditures_ClientId",
                table: "Expenditures",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Expenditures_CostCategoryId",
                table: "Expenditures",
                column: "CostCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Expenditures_IssuerId",
                table: "Expenditures",
                column: "IssuerId");
